...
* 會議參與者: (張宸瑋、大周、裸男)
  * 章節推進到【Cmake 教學】
  * 預計下一次持續到進度【Cmake 教學】的一半
    重點會放在之前知識的複習以及討論作業
  * 作業: 草擬 [logger](https://www.notion.so/1f78413ce7ec804b98d1cc8a8b779b2c)

## 🗓️ 7/3：小專題第三次革命 part 1

> 關聯 PR [#2](https://github.com/Bongo044152/little_chat_project/pull/2) :
* 更改 cmake 的架構，使其輸出更加完整
  * 對 cmake 新增 option 和 set 屬性，可使透過指令客製化某些內容 ( 例如要不要建構 ctest )
  * 更漂亮的 message 輸出，參考 FTXUI

* 為 logger 添加巨集，未來可能需要改掉，我覺得不太好但目前先這樣
  * Logger::setLevel 新增了多載，配合 cmake 的巨集行為 (超爛好嗎!!??)

* 測試、實驗 CI

> 關聯 PR [#3](https://github.com/Bongo044152/little_chat_project/pull/3) :
* CI 添加程式碼風格檢查
* 並且更改目前所有文件的代碼風格

## 🗓️ 7/4：小專題第三次革命 part 2 + 第三次會議

* 為 CI 添加 cppcheck，但是因為版本問題只能作罷 -> 關聯 PR [#4](https://github.com/Bongo044152/little_chat_project/pull/4)

CI 失敗後，我打算改成添加到 git hook，但是還是有一些問題 -> PR [#5](https://github.com/Bongo044152/little_chat_project/pull/5)

正如 PR 上所寫的訊息，我打算看看之後小專題的合作情況，在決定 git hook 要不要強制整合到 github

* 小專題第四次革命，預期事項:
  1. 繼續強化現有工具的使用
  2. 引入記憶體安全檢查 valgrind
  3. 嘗試突破環境的限制，並且著手研究如何 release 以及跨平台
  4. 安裝檔? 需要嗎?
